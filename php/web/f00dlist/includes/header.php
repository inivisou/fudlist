...
<nav style="background: #2c3e50; padding: 15px 0; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <div style="max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; padding: 0 20px;">
        <a href="<?= url('index.php') ?>" style="color: white; text-decoration: none; font-size: 1.5rem; font-weight: bold;">f00dlist</a>
        
        <div style="display: flex; gap: 15px; align-items: center;">
            <?php if (isLoggedIn()): ?>
                <a href="<?= url('index.php') ?>" style="color: #ecf0f1; text-decoration: none; <?= $currentPath === '/f00dlist/index.php' ? 'font-weight:bold;' : '' ?>">Dashboard</a>
                <a href="<?= url('favoritos.php') ?>" style="color: #ecf0f1; text-decoration: none; <?= strpos($currentPath, 'favoritos') !== false ? 'font-weight:bold;' : '' ?>">Favoritos</a>
                <a href="<?= url('perfil.php') ?>" style="color: #ecf0f1; text-decoration: none; <?= strpos($currentPath, 'perfil') !== false ? 'font-weight:bold;' : '' ?>">Perfil</a>
                ...
                <span style="color: #bdc3c7; font-size: 0.9rem;">Hola, <?= sanitize(getCurrentUsername()) ?></span>
                <a href="<?= url('logout.php') ?>" style="color: #e74c3c; text-decoration: none; font-weight: bold;">Salir</a>
            <?php else: ?>
                <a href="<?= url('login.php') ?>" style="color: #ecf0f1; text-decoration: none;">Login</a>
